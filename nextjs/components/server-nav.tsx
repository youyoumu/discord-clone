...
export async function ServerNav() {
  ...
  return (
    <div className="flex flex-col p-2 w-20 min-w-20 max gap-2 border-e border-border justify-between min-h-full max-h-full items-center dark:border-none dark:bg-teal-950">
      <ServerDiscoverLink />
